...
#if defined(NDEBUG)
# error "SmartCryptoTech cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "SmartCryptoTech Signed Message:\n";
...
{
    RenameThread("smartcryptotech-loadblk");
