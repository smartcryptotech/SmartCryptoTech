...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 0);\n"
...
"border-radius: 5px;"));
        ...
        payAmount->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"border-radius:0px;"));
        ...
        payTo->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"border-radius:0px;\n"
"padding-right:5px;"));
        ...
        addAsLabel->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"border-radius:0px;"));
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. SZFPLNkyK6w3UgpweVapFfCVABHYGKyMvv)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
