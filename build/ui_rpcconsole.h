...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        tab_info->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 0);\n"
"color: rgb(255, 255, 255);"));
        ...
        openDebugLogfileButton->setStyleSheet(QString::fromUtf8("background-color: rgb(48,140,198);"));
        ...
        showCLOptionsButton->setStyleSheet(QString::fromUtf8("background-color: rgb(48,140,198);"));
        ...
        tab_console->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 0);\n"
"color: rgb(255, 255, 255);"));
...
"color: rgb(0, 0, 0);"));
        ...
        tab->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 0);\n"
"color: rgb(255, 255, 255);"));
        ...
        sldGraphRange->setStyleSheet(QString::fromUtf8("color: rgb(164, 23, 91);"));
        ...
        btnClearTrafficGraph->setStyleSheet(QString::fromUtf8("background-color: rgb(48,140,198);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "SmartCryptoTech - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "SmartCryptoTech Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SmartCryptoTech debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the SmartCryptoTech-Qt help message to get a list with possible SmartCryptoTech command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
