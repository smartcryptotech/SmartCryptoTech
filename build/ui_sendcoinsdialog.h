...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        frameCoinControl->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 0);\n"
...
"border-radius: 5px;"));
        ...
        pushButtonCoinControl->setStyleSheet(QString::fromUtf8("background-color: rgb(48,140,198);\n"
"padding:5px;\n"
"border-radius:0px;\n"
"padding:5px 10px;"));
        ...
        lineEditCoinControlChange->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"border-radius:0px;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 842, 159));
